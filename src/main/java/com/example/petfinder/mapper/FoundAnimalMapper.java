...
@Slf4j
public class FoundAnimalMapper {
    protected ImageMapper imageMapper;

    public AnimalCard animalToCard(FoundAnimal animal) {
    ...
    public AnimalView animalToView(FoundAnimal animal) throws DataFormatException, IOException {
    ...
    public FoundAnimal newToFoundAnimal(AnimalCreation animalCreation) throws IOException {
